odoo.define('lbs_dashboard.import_button', function(require) {
...
//    var Sidebar = require('web.Sidebar');
    ...
    ListController.include({
       ...
       _getActionMenuItems: function (state) {
        ...
        if (this.modelName == "lbs.dashboard"){
    ...
    core.action_registry.add('lbs_dashboard.import_button', ListController);
