odoo.define('lbs_dashboard.ks_dashboard_filter', function (require) {
"use strict";

var KsFilterProps = require('lbs_dashboard.ks_dashboard');
...
return KsFilterProps.include({
    ...
    ksGetParamsForItemFetch: function(item_id) {
        ...
        var lbs_domain_1 = self.ks_dashboard_data.ks_dashboard_domain_data[model1] && self.ks_dashboard_data.ks_dashboard_domain_data[model1]['domain'] || [];
        var lbs_domain_2 = self.ks_dashboard_data.ks_dashboard_domain_data[model2] && self.ks_dashboard_data.ks_dashboard_domain_data[model2]['domain'] || [];

        return {
            lbs_domain_1: lbs_domain_1,
            lbs_domain_2: lbs_domain_2,
        }
    },
