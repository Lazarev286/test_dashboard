odoo.define('ks_dashboard_ninja_list.ks_to_do_preview', function(require) {
    ...
    var KsToDOViewPreview = AbstractField.extend({
        ...
        ksRenderToDoView: function(rec) {
            ...
            var lbs_font_color = self._ks_get_rgba_format(rec.lbs_font_color);
            ...
            $todoViewContainer.find('.ks_card_header').addClass('ks_bg_to_color').css({"color": lbs_font_color + ' !important' });
            $todoViewContainer.find('.ks_li_tab').addClass('ks_bg_to_color').css({"color": lbs_font_color + ' !important' });
            $todoViewContainer.find('.ks_chart_heading').addClass('ks_bg_to_color').css({"color": lbs_font_color + ' !important' });
