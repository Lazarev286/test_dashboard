odoo.define('lbs_dashboard.ks_to_do_dashboard_filter', function (require) {
"use strict";

var KsDashboard = require('lbs_dashboard.ks_dashboard');
...
//                            self.grid.addWidget($(item_view), self.gridstackConfig[items[i].id].x, self.gridstackConfig[items[i].id].y, self.gridstackConfig[items[i].id].width, self.gridstackConfig[items[i].id].height, false, 6, null, 2, 2, items[i].id);
                    ...
                    }  else if (items[i].dashboard_item_type === 'ks_to_do'){
        ...
        ksRenderToDoDashboardView: function(item){
            ...
            var lbs_font_color = self._ks_get_rgba_format(item.lbs_font_color);
            ...
            $ks_gridstack_container.find('.ks_card_header').addClass('ks_bg_to_color').css({"color": lbs_font_color + ' !important' });
            $ks_gridstack_container.find('.ks_li_tab').addClass('ks_bg_to_color').css({"color": lbs_font_color + ' !important' });
            $ks_gridstack_container.find('.ks_list_view_heading').addClass('ks_bg_to_color').css({"color": lbs_font_color + ' !important' });
